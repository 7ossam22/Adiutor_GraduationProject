            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("error")) {
                        ...
                        final JSONObject subjectObject = (JSONObject) arr.get(0);
                        final Subject_Data subjectData = new Subject_Data();
                        subjectData.setID(subjectObject.getInt("ID"));
                        subjectData.setName(subjectObject.getString("Name"));
                        subjectData.setDay(subjectObject.getString("Day"));
                        subjectData.setTime(subjectObject.getString("Time"));
                        subjectData.setPlace(subjectObject.getString("Place"));
                        subjectData.setType(subjectObject.getString("Type"));
